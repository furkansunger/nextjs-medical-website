    ...
    >
      <Grid sx={{ padding: "25px" }} container>
        ...
        <Grid sx={{ padding: { xs: "5px", md: "20px" }, }} item xs={12} md={6}>
          ...
          >
            <Box>
              <Typography sx={{ fontSize: { xs: "21px", sm: "30px", md: "38px" } }}>Dr.Aykut Gok</Typography>
              <Typography sx={{ fontSize: { xs: "11px", sm: "17px", md: "21px" }, color: "#333" }}>
            ...
            <Box>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography sx={{ fontSize: { xs: "14px", sm: "17px", md: "21px" } }} ml={1}>info@aykutgok.com</Typography>
              </Box>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <AiOutlinePhone style={{ color: "#00adb5" }} />
                <Typography sx={{ fontSize: { xs: "14px", sm: "17px", md: "21px" } }} ml={1}>+90 532 419 88 68</Typography>
              </Box>
            </Box>
          </Box>
          {/* <Grid xs={12}> */}
