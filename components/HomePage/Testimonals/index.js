            ...
            >
                {
                    dummyData.map((item) => {
                        return (
                            ...
                            <SwiperSlide style={{ textAlign: "center", padding: "30px 70px 50px 70px" }}>
                                <Grid sx={{ padding: { xs: "0px", md: "70px 120px 70px 120px" } }} container>
                                    <Grid sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", fontSize: { xs: "16px", sm: "19px", md: "24px" }, textAlign: { xs: "center", md: "start" }, }} item xs={12} md={8}>
                                        {item.comment}
                                    </Grid>
                                    <Grid sx={{ marginTop: { xs: "25px", md: "0px" }, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }} item xs={12} md={4}>
                                        <Avatar
                                            alt="Remy Sharp"
                                            src={item.image}
